...
Este algoritmo encuentra todas las cadenas *z* tales que *b* * *z* = 0 (mod 2), con las que se podrá hallar el valor de *b* a partir del sistema de ecuaciones asociado.
